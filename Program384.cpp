...
typedef struct inode
{
    ...
    struct inode *next;  // only next mhanje singly linkedlist ahe
...
void man(char *name)
{
    ...
    {
        printf("Description : Used to regulate new regular file\n");
    ...
    else if(strcmp(name,"write") == 0)
    {
        ...
        printf("Usage : write File_name NO_Of_Bytes_To_write\n");
    }
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret == -1)
                    printf("nERROR : Permission denied\n");
                if(ret == -2)
                    printf("nERROR : There is no such sufficient memory to write\n");
                if(ret == -3)
                    printf("nERROR : It is not regular file\n");
            }
